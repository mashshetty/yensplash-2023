...
import team1 from "../../public/mash.jpg";
    ...
    <div className={styles.team_container}>
      <div className={styles.profile_card_container}>
        <div className={styles.profile_img}>
          <Image width="150px" height="150px" src={team1} />
        </div>
      ...
      <div className={styles.profile_card_container}>
        <div className={styles.profile_img}>
          <Image width="150px" height="150px" src={team2} />
        </div>
        <div className={styles.profile_info}>
      ...
      <div className={styles.profile_card_container}>
        <div className={styles.profile_img}>
          <Image width="150px" height="150px" src={team3} />
        </div>
        <div className={styles.profile_info}>
      ...
      <div className={styles.profile_card_container}>
        <div className={styles.profile_img}>
          <Image width="150px" height="150px" src={team4} />
        </div>
        <div className={styles.profile_info}>
      ...
      <div className={styles.profile_card_container}>
        <div className={styles.profile_img}>
          <Image width="150px" height="150px" src={team5} />
        </div>
        <div className={styles.profile_info}>
